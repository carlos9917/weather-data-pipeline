...
![Dashboard snapshots](figs/dashboard_samples.png)
...
- **Include ensemble data**: for probabilistic forecasting

- **Download observational data**: needed to do the validation of the simulations.

- **Improve visualizations**: using web optimized tools like `weatherlayers-gl`.
